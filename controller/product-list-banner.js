...
const PromotionalOffer = require('../models/product-list-banner');
...
exports.addProductListBanner = async (req, res, next) => {
...
exports.addNewProductListBannerMulti = async (req, res, next) => {
...
exports.getAllProducListBanner = async (req, res, next) => {
    try {
...
exports.getSingleProductBannerById = async (req, res, next) => {
...
exports.getSingleProductBannerBySlug = async (req, res, next) => {
...
exports.deleteProductBannerById = async (req, res, next) => {
    const id = req.params.id;
    const query = {_id: id}
...
exports.deleteProductBannerMulti = async (req, res, next) => {
...
exports.editProductListBannerData = (req, res, next) => {
    const errors = validationResult(req);
    if (!errors.isEmpty()) {
        const error = new Error('Input Validation Error! Please complete required information.');
        error.statusCode = 422;
