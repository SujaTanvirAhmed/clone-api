...
function getModelData(collectionName) {
    ...
    switch (collectionName) {
        ...
        case 'Blog': case 'blog':
            ...
            fileName = `blog.json`;
            break;
        case 'CareerEsquire': case 'career-esquire':
            model = CareerEsquire;
        ...
        case 'Cart': case 'cart':
            ...
            fileName = `cart.json`;
            break;
        case 'CategoryMenu': case 'category-menu':
            model = CategoryMenu;
        ...
        case 'Coupon': case 'coupon':
            ...
            break;
        case 'DealOnPlay': case 'deal-on-play':
            model = DealOnPlay;
            fileName = `deal-on-play.json`;
            break;
        case 'DealerInfo': case 'dealer-info':
            model = DealerInfo;
            fileName = `dealer-info.json`;
            break;
        case 'DealsOfTheDay': case 'deals-of-the-play':
            model = DealsOfTheDay;
            fileName = `deals-of-the-play.json`;
            break;
        case 'Discussion': case 'discussiony':
            model = Discussion;
        ...
        case 'Faq': case 'faq':
            ...
            fileName = `faq.json`;
            break;
        case 'FeaturedCategory': case 'featured-category':
            model = FeaturedCategory;
            fileName = `featured-category.json`;
            break;
        case 'FeaturedProduct': case 'featured-producty':
            model = FeaturedProduct;
            fileName = `featured-product.json`;
            break;
        case 'FlashSale': case 'flash-sale':
            model = FlashSale;
            fileName = `flash-sale.json`;
            break;
        case 'FooterData': case 'footer-data':
            model = FooterData;
        ...
        case 'Gallery': case 'gallery':
            ...
            break;
        case 'HomepageLists': case 'homepage-list':
            model = HomepageLists;
        ...
        case 'ImageFolder': case 'image-folder':
            ...
            break;
        case 'InstallationRepairType': case 'installation-repair-type':
            model = InstallationRepairType;
            fileName = `installation-repair-type.json`;
            break;
        case 'InstallationRepair': case 'installation-repair':
        ...
        case 'PageInfo': case 'page-info':
            ...
            break;
        case 'ProductAttribute': case 'product-attribute':
            model = ProductAttribute;
            fileName = `product-attribute.json`;
            break;
        case 'ProductAuthenticator': case 'product-authenticator':
            model = ProductAuthenticator;
            fileName = `product-authenticator.json`;
            break;
        case 'ProductBrand': case 'product-brand':
            model = ProductBrand;
            fileName = `product-brand.json`;
            break;
        case 'ProductCategory': case 'product-category':
        ...
        case 'ProductExtraData': case 'product-extra-data':
            ...
            break;
        case 'ProductParentCategory': case 'product-parent-category':
            model = ProductParentCategory;
            fileName = `product-parent-category.json`;
            break;
        case 'ProductRatingReview': case 'product-rating-review':
            model = ProductRatingReview;
            fileName = `product-rating-review.json`;
            break;
        case 'ProductSubCategory': case 'product-sub-category':
            model = ProductSubCategory;
            fileName = `product-sub-category.json`;
            break;
        case 'Tag': case 'product-tag':
            model = Tag;
            fileName = `product-tag.json`;
            break;
        case 'ProductVariation': case 'product-variation':
        ...
        case 'Product': case 'product':
            ...
            break;
        case 'PromoPage': case 'promo-page':
            model = PromoPage;
            fileName = `promo-page.json`;
            break;
        case 'PromotionalBanner': case 'promotional-banner':
            model = PromotionalBanner;
            fileName = `promotional-banner.json`;
            break;
        case 'PromotionalOffer': case 'promotional-offer':
        ...
        case 'Role': case 'role':
            ...
            fileName = `role.json`;
            break;
        case 'ExtraData': case 'shipping-charge':
            model = ExtraData;
            fileName = `shipping-charge.json`;
            break;
        case 'ShopInfo': case 'shop-info':
            model = ShopInfo;
            fileName = `shop-info.json`;
            break;
        case 'StoreInfo': case 'store-info':
            model = StoreInfo;
