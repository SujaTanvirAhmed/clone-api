...
exports.getAllDealOnPlay = async (req, res, next) => {
    try {
        ...
        const data = await queryData.populate(
            {
            path: 'products', 
            select: '_id productName productSlug sku images price discountType discountAmount quantity productVisibility',
...
exports.getSingleDealOnPlayBySlug = async (req, res, next) => {
