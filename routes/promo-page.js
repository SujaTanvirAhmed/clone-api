...
router.get('/get-promo-page-by-id/:promoPageId', controller.getPromoPagebyId);
router.put('/edit-promo-page',checkIpWhitelist,checkAdminAuth, controller.editPromoPageInfo);
